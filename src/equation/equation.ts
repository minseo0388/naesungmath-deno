 ...
 * 
 */
export function rootFormula_plus(a : number, b : number, c : number) {
 ...
 * 
 */
export function rootFormula_minus(a : number, b : number, c : number) {
    return ((-b - (((b ** 2) - (4 * a * c)) ** 0.5)) / (2 * a))
}
 ...
 * 
 */
export function rootFormula_EvenPlus(a : number, b : number, c : number) {
 ...
 * 
 */
export function rootFormula_EvenMinus(a : number, b : number, c : number) {
    return ((-(0.5 * b) - ((((0.5 * b) ** 2) - (a * c)) ** 0.5)) / a)
}
 ...
 * 
 */
export function rootAndCoefficient(a : number, b : number, c : number, type : number) {
 ...
 * 
 */
export function cubicEquation_first(a : number, b : number, c : number, d : number) {
